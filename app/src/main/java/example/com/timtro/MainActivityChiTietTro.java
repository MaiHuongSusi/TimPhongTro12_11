...
public class MainActivityChiTietTro extends AppCompatActivity
   ...
   //ham xu li mục setting
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.tim_phong) {
            Intent intent = new Intent(MainActivityChiTietTro.this, ActivityMap.class);
            startActivity(intent);

        } else if (id == R.id.tim_ghep) {
            Intent intent = new Intent(MainActivityChiTietTro.this, ActivityTimOGhep.class);
            startActivity(intent);

        } else if (id == R.id.dang_cho_thue) {
            Intent intent = new Intent(MainActivityChiTietTro.this, ActivityDangTinChoThue.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(MainActivityChiTietTro.this, ActivityTabBaocao.class);
            startActivity(intent);
        }
