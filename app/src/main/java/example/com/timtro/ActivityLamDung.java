...
public class ActivityLamDung extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_lamdung);
    ...
    public void onClickGui() {
        ...
        if (str1.length() == 0) {
            Toast.makeText(ActivityLamDung.this, "Hãy nhập Email.", Toast.LENGTH_LONG).show();

        } else {
            if (str2.length() == 0) {
                Toast.makeText(ActivityLamDung.this, "Hãy nhập phản hồi.", Toast.LENGTH_LONG).show();
            } else {
                addDataToFirebase();
                Toast.makeText(ActivityLamDung.this, "Đã gửi phản hồi.", Toast.LENGTH_LONG).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.tim_phong) {
            Intent intent = new Intent(ActivityLamDung.this, ActivityMap.class);
            startActivity(intent);

        } else if (id == R.id.tim_ghep) {
            Intent intent = new Intent(ActivityLamDung.this, ActivityTimOGhep.class);
            startActivity(intent);

        } else if (id == R.id.dang_cho_thue) {
            Intent intent = new Intent(ActivityLamDung.this, ActivityDangTinChoThue.class);
            startActivity(intent);

        } else if (id == R.id.dang_tim_ghep) {
            Intent intent = new Intent(ActivityLamDung.this, ActivityDangTinOGhep.class);
            startActivity(intent);

        } else if (id == R.id.bao_cao) {
            Intent intent = new Intent(ActivityLamDung.this, ActivityTabBaocao.class);
            startActivity(intent);
        }
