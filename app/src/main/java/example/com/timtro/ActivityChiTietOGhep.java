...
public class ActivityChiTietOGhep extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle bundle = intent.getBundleExtra(ActivityTimOGhep.BULDE);
   ...
   //ham xu li mục setting
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.tim_phong) {
            Intent intent = new Intent(ActivityChiTietOGhep.this, ActivityMap.class);
            startActivity(intent);

        } else if (id == R.id.tim_ghep) {
            Intent intent = new Intent(ActivityChiTietOGhep.this, ActivityTimOGhep.class);
            startActivity(intent);

        } else if (id == R.id.dang_cho_thue) {
            Intent intent = new Intent(ActivityChiTietOGhep.this, ActivityDangTinChoThue.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(ActivityChiTietOGhep.this, ActivityTabBaocao.class);
            startActivity(intent);
        }
